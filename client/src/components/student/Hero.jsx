...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center w-full pt-16 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-8 max-w-6xl mx-auto">
        {/* Stats Badge */}
        <div className="flex items-center gap-6 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-white/20">
        ...
        <div className="space-y-6">
          <h1 className="relative font-bold text-gray-800 max-w-4xl mx-auto text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight animate-fade-in-up">
            <span className="inline-block animate-slide-in-left">
              Empower your future with
            </span>{" "}
            <span className="relative inline-block mx-2 animate-slide-in-right">
              ...
              <img
                className="hidden md:block absolute -bottom-3 -right-6 w-16 h-auto animate-bounce-slow"
                src={assets.sktech}
                alt=""
              />
            </span>
        ...
        <div className="space-y-4 animate-fade-in-up delay-500">
          ...
          <p className="md:hidden text-gray-600 max-w-sm mx-auto text-base leading-relaxed">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 animate-fade-in-up delay-700">
          <button className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-3">
            Get Started Now
            <FiArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
          </button>

          <button className="group bg-white/80 backdrop-blur-sm hover:bg-white text-gray-700 font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 border border-gray-200/50">
